 ...
 * @since Version 1.0
 */
- (void)bcChatSessionImpl:(BCChatSessionImpl *)chatSession didCreateUnavailableWithReason:(UnavailableReason)reason unavailableForm:(BCForm *)unavailableForm unavailableMessage:(NSString *)message;
