 ...
 * @since Version 1.0
 */
- (void)bcChatAvailability:(id<BCCancelable>)cancelable chatUnavailableForReason:(UnavailableReason)reason;
...
/**
 * @brief The chat departments.
 * @since Version 2.0
 */
- (void)bcChatDepartments:(NSArray<Department *> *)departments cancelable:(id<BCCancelable>)cancelable;

/**
 * @brief Chat departments could not be checked.
 * @param cancelable The cancelable object of the request calling this check.
 * @param error The error object for the current failure. Check error.code with \link BCErrorCodes.h \endlink to get the exact error.
 * @since Version 2.0
 */
- (void)bcChatDepartments:(id<BCCancelable>)cancelable didFailWithError:(NSError *)error;
