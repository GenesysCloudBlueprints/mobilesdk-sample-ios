...
/**
 GetChatDepartmentsCall REST call generation.
 @returns A preconfigured instance of BCGetChatDepartmentsCall.
 @since Version 1.0
 */
- (BCGetChatDepartmentsCall *)getChatDepartmentsCall;
