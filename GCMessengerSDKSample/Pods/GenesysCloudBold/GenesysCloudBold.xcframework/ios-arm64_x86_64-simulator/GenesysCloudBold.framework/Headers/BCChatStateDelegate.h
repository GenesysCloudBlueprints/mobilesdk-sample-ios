 ...
 * @since Version 1.0
 */
- (void)bcChat:(id<BCChat>)chat didFinishWithUnavailableReason:(UnavailableReason)reason unavailableForm:(BCForm *)unavailableForm unavailableMessage:(NSString *)message;
