...
//! Project version number for GenesysCloudBot.
FOUNDATION_EXPORT double GenesysCloudBotVersionNumber;

//! Project version string for GenesysCloudBot.
FOUNDATION_EXPORT const unsigned char GenesysCloudBotVersionString[];
